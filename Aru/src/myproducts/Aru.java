...
public class Aru {
	...
	public void nettoarnovelese(int szazalek){
		netto_ar += (int) (netto_ar * (1 + szazalek / 100.0));
	}
	
	public int osszehasonlitas(Aru masodikaru) {
		if (brutto_ar() > masodikaru.brutto_ar() ) {
			return 1;
		}
			
		else if (brutto_ar()< masodikaru.brutto_ar() ){
	    	return -1;
		} else {
			return 0;
